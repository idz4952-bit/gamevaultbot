...
DEFAULT_PRODUCTS = [
    ...
    ("🪂 PUBG MOBILE UC VOUCHERS", "60 UC", 0.875, "MANUAL", 1),
    ("🪂 PUBG MOBILE UC VOUCHERS", "325 UC", 4.375, "MANUAL", 1),

    ("💎 GARENA FREE FIRE VOUCHERS (OFFICIAL)", "1 USD - 100+10", 0.920, "MANUAL", 1),
    ("💎 GARENA FREE FIRE VOUCHERS (OFFICIAL)", "2 USD - 210+21", 1.840, "MANUAL", 1),

    ("🎲 YALLA LUDO", "3.7K Hearts + 10 RP", 9.000, "MANUAL", 1),
